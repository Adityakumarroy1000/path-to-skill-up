    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600">Continue your learning journey and reach your goals.</p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="text-center">
            <CardContent className="p-6">
              ...
              <div className="text-2xl font-bold text-gray-900 mb-1">{userStats.totalSkills}</div>
          ...
          <Card className="text-center">
            <CardContent className="p-6">
              ...
              <div className="text-2xl font-bold text-gray-900 mb-1">{userStats.completedSkills}</div>
          ...
          <Card className="text-center">
            <CardContent className="p-6">
              ...
              <div className="text-2xl font-bold text-gray-900 mb-1">{userStats.totalHours}h</div>
          ...
          <Card className="text-center">
            <CardContent className="p-6">
              ...
              <div className="text-2xl font-bold text-gray-900 mb-1">{userStats.streak}</div>
                ...
                <div className="flex items-end justify-between h-32 gap-2">
                  {weeklyActivity.map((day) => (
                    <div key={day.day} className="flex flex-col items-center flex-1">
                      <div 
                        className="bg-gradient-to-t from-blue-500 to-purple-500 rounded-t w-full mb-2 transition-all hover:opacity-80"
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      <span>Complete 5 resources</span>
                      <span>3/5</span>
                    </div>
